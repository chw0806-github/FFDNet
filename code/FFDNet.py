...
from utils import weights_init_kaiming, batch_psnr, init_logger, svd_orthogonalization
...
class FFDNet(nn.Module):
    ...
    Implementation adapted from https://github.com/cszn/KAIR
    '''
    ...
    for epoch in range(start_epoch, epochs):
        ...
        for i, data in enumerate(loader_train, 0):
            ...
            if loader_train.dataset.normalize:
                img_noised *= dl_test.dataset.normalization_value
